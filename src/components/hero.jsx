...
export default function Hero() {
    return (
        (<section
            className="relative container mx-auto flex w-full flex-col items-center p-4 py-28 xl:px-6">
            <div className="flex w-full max-w-3xl flex-col items-center gap-4">
                ...
                <m.p
                    ...
                    and{' '}
                    <a href="https://tailwindcss.com/" className="underline underline-offset-4">
                        Tailwind CSS
                    </a>{' '}
                    — featuring the{' '}
                    <a
                    ...
                    sourced from{' '}
                    <a href="https://magicui.design" className="underline underline-offset-4">
                        Magic UI
                    </a>
                    .
                </m.p>
            ...
            <div className="relative mt-14 flex w-full max-w-7xl">
                ...
                <div
                    className="from-background via-background pointer-events-none absolute right-0 bottom-0 left-0 z-40 h-[60%] bg-gradient-to-t to-transparent" />
                <m.div
                    animate={{ opacity: 1 }}
                    initial={{ opacity: 0 }}
                    transition={{
