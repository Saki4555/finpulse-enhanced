...
//   return (
//     <section id="team" className="py-24 bg-gradient-to-br from-background via-muted/30 to-background relative overflow-hidden">
...
//         <div className="absolute bottom-1/3 right-1/4 w-80 h-80 bg-primary/3 dark:bg-primary/8 rounded-full blur-3xl animate-pulse delay-1000"></div>
//         <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-72 h-72 bg-primary/4 dark:bg-primary/6 rounded-full blur-3xl animate-pulse delay-2000"></div>
        
//         {/* Animated grid pattern */}
//         <div className="absolute inset-0 opacity-[0.03] dark:opacity-[0.08]">
//           <div className="absolute inset-0 bg-[radial-gradient(circle_at_1px_1px,hsl(var(--primary))_1px,transparent_0)] bg-[length:60px_60px]"></div>
//         </div>
//       </div>
...
//             className="inline-block mb-6 px-8 py-3 bg-primary/10 dark:bg-primary/20 rounded-md border border-primary/20 dark:border-primary/30 backdrop-blur-sm"
//           >
//             <span className="text-primary text-sm font-semibold tracking-wider uppercase">Our Leadership Team</span>
//           </m.div>
...
//             className="relative bg-card/60 backdrop-blur-xl rounded-3xl border border-border shadow-2xl overflow-hidden group"
//             style={{
//               boxShadow: '0 25px 50px -12px hsl(var(--foreground) / 0.1), 0 0 0 1px hsl(var(--border)), inset 0 1px 0 hsl(var(--background) / 0.1)'
//             }}
//           >
//             {/* Animated border gradient */}
//             <div className="absolute inset-0 bg-gradient-to-r from-primary/10 via-primary/5 to-primary/10 rounded-3xl opacity-0 group-hover:opacity-100 transition-opacity duration-700 blur-sm"></div>
            
//             {/* Team Member Display */}
//             <div className="relative flex flex-col md:flex-row">
//               {/* Enhanced Image Container */}
//               <div className="md:w-1/2 relative group/image p-8">
...
//                 {/* Quote icon */}
//                 <div className="absolute top-6 left-6 w-8 h-8 text-primary/25">
...
//                   transition={{ duration: 0.6, delay: 0.2 }}
//                   className="text-xl md:text-2xl italic text-foreground/85 mb-8 leading-relaxed font-light relative z-10"
//                 >
//                   "{currentMember.quote}"
//                 </m.blockquote>
...
//                 >
//                   <h3 className="text-3xl md:text-4xl font-bold bg-gradient-to-r from-foreground to-foreground/90 bg-clip-text text-transparent mb-3">
//                     {currentMember.name}
//                   </h3>
//                   <div className="flex items-center space-x-3">
//                     <div className="w-12 h-0.5 bg-gradient-to-r from-primary to-primary/80 rounded-full"></div>
//                     <p className="text-primary/70 text-lg font-medium tracking-wide">{currentMember.role}</p>
//                   </div>
//                 </m.div>
//               </div>
//             </div>
...
//                 whileTap={{ scale: 0.95 }}
//                 className="bg-background/60 backdrop-blur-md border border-border rounded-full p-4 shadow-lg hover:shadow-xl hover:bg-primary/10 hover:border-primary/30 transition-all duration-300 group"
